...
const Contact = () => {
  return (
        ...
        <ul className='my-auto pr-6'>
            <li className='flex'>
                ...
                <div className='m-5'>
                    ...
                    <p className='text-gray-400'>Mobile:9000203129</p>
                    <p className='text-gray-400'>Email:20kq1a6159aiml@gmail.com</p>
                </div>
                </li>
    ...
    <form action="https://getform.io/f/bgddgeza" method="POST" className='max-w-6xl p-5 md:p-12 ' id="form">
        <input
        type="text"
        id="name"
        ...
        <button type='submit' className='w-full py-3 rounded-md text-gray-200 font-semibold text-xl
         bg-gradient-to-r from-[#50a7c7] via-[#1f7c8f] to-[#3d6ca4]'>Send Meassage</button>
